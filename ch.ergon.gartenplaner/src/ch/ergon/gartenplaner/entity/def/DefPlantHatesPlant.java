...
/**
 * Association of plants hating each other.
 * @author albin
 */
@Entity
public class DefPlantHatesPlant {
    @Id
    // no sequence needed, because it's a readonly table for hibernate
    private int defPlantHatesPlantNo;
